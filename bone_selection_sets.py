...
class SelectionEntry( PropertyGroup ):
    '''선택된 Bone의 이름 저장'''
    name: StringProperty( name="Bone Name", override={'LIBRARY_OVERRIDABLE'} ) # type: ignore


class SelectionSet( PropertyGroup ):
    '''선택된 Bone들의 집합 저장'''
    name: StringProperty( name="Set Name", override={'LIBRARY_OVERRIDABLE'} ) # type: ignore
    bone_ids: CollectionProperty(
        type=SelectionEntry,
        override={'LIBRARY_OVERRIDABLE', 'USE_INSERTION'}
    ) # type: ignore
    is_selected: BoolProperty( name="Is Selected", override={'LIBRARY_OVERRIDABLE'} ) # type: ignore
...
def to_json( context: Context ) -> str:
...
def from_json( context: Context, as_json: str ):
